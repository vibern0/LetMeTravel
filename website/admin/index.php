<html>
    ...
    <body>
        ...
        <table border="1px solid black">
            <tr>
                <th>From</th><th>To</th><th>Price</th>
            </tr>
        </table>
        <button type="button" onclick="add_price()">Register</button>
        <span id="new_price_output"></span>
        ...
        <button type="button" onclick="add_new_station()">Add new station</button><br/>
        <button type="button" onclick="add_traject()">Register Traject</button>
